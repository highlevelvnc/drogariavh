...
const sections = [
  {
    ...
    content:
      "A entidade responsável pelo tratamento dos seus dados pessoais é a Drogaria VH, com sede em Sintra, Portugal. Para qualquer questão relacionada com a proteção de dados, pode contactar-nos através do WhatsApp 926 010 809.",
  },
  {
    icon: "description",
  ...
  },
  {
    ...
    title: "Direitos",
    content:
      "Nos termos do Regulamento Geral sobre a Proteção de Dados (RGPD), tem direito de acesso, retificação e eliminação dos seus dados pessoais. Para exercer qualquer um destes direitos, contacte-nos através do WhatsApp 926 010 809.",
  },
  {
    icon: "cookie",
    title: "Cookies",
  ...
  return (
    <div className="pt-32 pb-24">
      <div className="max-w-screen-2xl mx-auto px-8">
        ...
        >
          A Drogaria VH compromete-se a proteger a privacidade dos visitantes do seu website.
